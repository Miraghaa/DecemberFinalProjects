...
//         let selectedStars = document.querySelectorAll(".star[data-rating='" + rating + "']");
...
//             selectedStar.style.color = "#ff6f2e";
//         });
//     });

//     star.addEventListener("mouseenter", function () {
//         let rating = star.getAttribute("data-rating");
//         let previousStars = document.querySelectorAll(".star[data-rating='" + rating + "']");
//         previousStars.forEach(function (previousStar) {
//             previousStar.classList.remove("fa-regular");
//             previousStar.classList.add("fa-solid");
//             previousStar.style.color = "#ff6f2e";
//         });
//     });
...
//         let previousStars = document.querySelectorAll(".star[data-rating='" + rating + "']");
//         previousStars.forEach(function (previousStar) {
//             previousStar.classList.remove("fa-solid");
//             previousStar.classList.add("fa-regular");
//             previousStar.style.color = "gray";
//         });
//     });
// });
